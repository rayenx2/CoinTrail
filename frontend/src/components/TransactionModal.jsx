      ...
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="flex justify-between items-center mb-10">
            <div>
              <h2 className="text-3xl font-black text-foreground tracking-tighter">New Movement</h2>
              <p className="text-muted text-sm mt-1 uppercase tracking-widest font-bold">Track your cash flow</p>
            </div>
            <button
              onClick={onClose}
