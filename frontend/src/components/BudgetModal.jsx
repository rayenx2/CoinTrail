...
export default function BudgetModal({ isOpen, onClose, onSave, categories, onCategoryCreated, editingBudget }) {
      ...
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        >
          <div className="flex justify-between items-center mb-10">
            <div>
              <h2 className="text-3xl font-black text-foreground tracking-tighter">{editingBudget ? 'Adjust Budget' : 'Set Budget'}</h2>
              <p className="text-muted text-sm mt-1 uppercase tracking-widest font-bold">Plan your spending limits</p>
            </div>
            <button
              onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            >
              <Target className="w-6 h-6" /> {editingBudget ? 'Update Budget Limit' : 'Save Budget Limit'}
            </button>
          </form>
        </motion.div>
      </div>
